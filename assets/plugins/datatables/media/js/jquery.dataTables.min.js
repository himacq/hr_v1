...
sEmptyTable:"لا يتوفر بيانات في هذا الجدول",sInfo:"عرض _START_ الى _END_ من _TOTAL_ سجلات",sInfoEmpty:"عرض 0 الى 0 من 0 سجلات",sInfoFiltered:"(تم البحث خلال _MAX_ اجمالي السجلات)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"عرض _MENU_ سجلات",sLoadingRecords:"تحميل....",sProcessing:"جاري جلب البيانات ...",sSearch:"بحث : ",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"لا توجد نتائج مطابقة"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
