...
<div class="col-xs-12" id="main">
    <div class="row m-b-20">
        <div class="col-xs-12 col-xl-12">
            <h4 class="M-title"> التحكم بثوابت النظام </h4> 
        </div>
    </div>
...
<div class="row m-b-20">
    <div class="col-xs-12">
        <h4 class="m-b-20">قائمة الثوابت</h4>
            ...
            <thead>
           	...
           	<tbody id="TableCntnt">
            	...
            	<tr>
                    ...
                    <td>
						<a href="getConstDetails/<?php echo $row->pk_i_id ?>">
...
$(document).ready(function(){
		...
		$("#formData").validate({
			...
			submitHandler: function() {
				...
				$.ajax({
					url: '<?php echo base_url() ?>AddConstant',
					type: 'POST',
					data: formData,
					dataType:"json",
					async: false,
					success: function (data) {
						if(data.status.success){	
							...
							$("#TableCntnt").append('<tr>'
								...
								+'<td>'+$("#s_name_en").val()+'</td>'
								+'<td>'
									+'<a href="getConstDetails/'+data.id+'">'
										+'<span class="fa fa-list-ul"></span>'
									+'</a>'
								+'</td>'
							+'</tr>')
