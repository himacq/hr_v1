...
<div class="col-xs-12" id="main">
        ...
        <div class="col-xs-12 col-xl-12">
            ...
            <div class="portlet box green m-b-30">               
                <div class="portlet-title">
                    <div class="caption"><i class="icon-cogs"></i>بيانات إظافية للشركة</div>
                    <div class="tools">
                        ...
                        <div class="row">   
                            <div class="col-sm-5 col-sm-offset-1" >
                                <div class="form-group floating-labels">
                                    <label for="s_addtional_data">البيانات</label>
                                    <input id="s_addtional_data" type="text" name="s_addtional_data">
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group floating-labels">
                                    <label for="s_addtional_dataVal">القيمة</label>
                                    <input id="s_addtional_dataVal"  type="text" name="s_addtional_dataVal">
                                </div>
                            </div>
    ...
    <div class="row m-b-20">
        <div class="col-xs-12">
            <h4 class="m-b-20">قائمة البيانات الإضافية</h4>
           <table id="example-1" class="table table-hover table-striped table-bordered M-table1" cellspacing="0" width="100%">
                ...
                <tbody id="TableCntnt">
                    ...
                    <tr id="tr<?php echo $i ?>">
                        <td><?php echo $i ?></td>
                        <td><?php echo 'بيانات '.$i ?></td>
                        <td><?php echo 'قيمة '.$i ?></td>
                        <td>
