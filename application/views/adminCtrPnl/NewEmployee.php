                ...
                <div class="row">
                    <div class="col-xs-12 col-xl-6">
                        <div class="form-group floating-labels">
                            <label for="i_emp_number">الرقم الوظيفي</label>
                            <input id="i_emp_number" autocomplete="off" type="text" name="i_emp_number" required data-error="الاسم مطلوب">
                ...
                <div class="row">
                    <div class="col-xs-12 col-xl-6">
                        <div class="form-group floating-labels">
                            ...
                            <input id="s_name_ar" autocomplete="off" type="text" name="s_name_ar" required data-error="الاسم مطلوب">
                            <p class="error-block hidden with-errors"></p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-xl-6">
                        <div class="form-group floating-labels">
                            ...
                            <input id="s_name_en" autocomplete="off" type="text" name="s_name_en">
                ...
                <div class="row">				                                
                    <div class="col-xs-12 col-xl-6">
                        <div class="form-group floating-labels">
                            ...
                            <input id="s_emp_ssn" autocomplete="off" type="text" name="s_emp_ssn">
                            <p class="error-block hidden"></p>
                        </div>
                    </div>			                               
                    <div class="col-xs-12 col-xl-6">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-xl-6">
                        <div class="form-group floating-labels">
                            ...
                            <input id="s_place_of_birth" autocomplete="off" type="text" name="s_place_of_birth">
                            <p class="error-block hidden"></p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-xl-6">
                        <div class="form-group floating-labels">
                            ...
                            <input id="s_password" autocomplete="off" type="password" name="s_password">
                            <p class="error-block hidden"></p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-xl-6">
                        <div class="form-group floating-labels">
                            ...
                            <input id="s_email" autocomplete="off" type="email" name="s_email">
                            <p class="error-block hidden"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                                <div class="col-xs-12 col-xl-6">
                                    <div class="form-group floating-labels">
                                        ...
                                        <input id="s_jawwal" autocomplete="off" type="text" name="s_jawwal">
                                        <p class="error-block hidden"></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-xl-6">
                                    <div class="form-group floating-labels">
                                        ...
                                        <input id="s_tel" autocomplete="off" type="text" name="s_tel">
                                        <p class="error-block hidden"></p>
                                    </div>
                                </div>
                            </div>
                <div class="row">
                                <div class="col-xs-12 col-xl-6">
                                    <div class="form-group floating-labels">
                                        ...
                                        <input id="fk_i_nationality_cd" autocomplete="off" type="text" name="fk_i_nationality_cd">
                                        <p class="error-block hidden"></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-xl-6">
		...
		$("#EmpFrm").validate({
			...
			messages: {
                i_emp_number: {
                    ...
                    minlength:  'طول الحقل لا يقل عن 2 حروف',
                },
				s_name_ar: {
					required: 'هذا الحقل مطلوب',
