...
$route['GetSmsGroup/(:num)'] = 'c_sms/group_byID/$1';
$route['DeleteSmsGroup/(:num)'] = 'c_sms/delete_group/$1';
$route['UpdateSmsGroup'] = 'c_sms/update_group';

$route['SmsGroupsContacts'] = 'c_sms/contacts';
$route['AddSmsContact'] = 'c_sms/add_member';
$route['GetSmsContact/(:num)'] = 'c_sms/contact_byID/$1';
$route['DeleteSmsContact/(:num)'] = 'c_sms/delete_contact/$1';
$route['UpdateSmsContact'] = 'c_sms/update_contact';
$route['SmsUploadContacts'] = 'c_sms/upload_contact';


$route['SmsLogs'] = 'c_sms/get_logs';

$route['SmsSend'] = 'c_sms/send_sms';
$route['DoSendSms'] = 'c_sms/do_send';

$route['AddSmsGroupNumbers/(:num)'] = 'c_sms/get_group_numbers/$1';
